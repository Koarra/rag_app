...
def generate_quarterly_pdf_report(quarter, months, entity_vals, crime_vals, passed, 
                                  failed_months, plot_path, output_path, threshold=0.85):
    """
    ...
    status_data = [
        ...
        ['#1', 'Entity Recall', f'≥ {threshold:.0%}', status_text],
        ['#2', 'Crime Recall', f'≥ {threshold:.0%}', status_text],
    ]
    ...
    for i, month in enumerate(months):
        ...
        month_passed = entity_vals[i] >= threshold and crime_vals[i] >= threshold
